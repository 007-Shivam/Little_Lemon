...
@Composable
fun PlkPan(context: Context = LocalContext.current, navController: NavHostController) {
        ...
        LazyColumn (
            ...
            item {
                Box(
                    ...
                    Text(
                        text = stringResource(id = R.string.plkpan),
                        style = TextStyle(
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
                            color = Color.Blue,
            ...
            item {
                Image(
                    painter = painterResource(id = R.drawable.palak_paneer),
            ...
            item {
                Text(
                    text = stringResource(id = R.string.plkpan_des),
            ...
            item {
                Text(
                    text = stringResource(id = R.string.plkpan_ing),
                    style = TextStyle(fontSize = 15.sp, color = Color.Black),
                    modifier = Modifier.padding(start = 10.dp, end = 10.dp, bottom = 10.dp)
                )
            }
