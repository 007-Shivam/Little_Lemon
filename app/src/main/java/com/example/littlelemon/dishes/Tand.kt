...
@Composable
fun Tand(context: Context = LocalContext.current, navController: NavHostController) {
        ...
        LazyColumn (
            ...
            item {
                Box(
                    ...
                    Text(
                        text = stringResource(id = R.string.tand),
                        style = TextStyle(
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
                            color = Color.Blue,
            ...
            item {
                Image(
                    painter = painterResource(id = R.drawable.tandoori),
            ...
            item {
                Text(
                    text = stringResource(id = R.string.tand_des),
            ...
            item {
                Text(
                    text = stringResource(id = R.string.tand_ing),
                    style = TextStyle(fontSize = 15.sp, color = Color.Black),
                    modifier = Modifier.padding(start = 10.dp, end = 10.dp, bottom = 10.dp)
                )
            }
