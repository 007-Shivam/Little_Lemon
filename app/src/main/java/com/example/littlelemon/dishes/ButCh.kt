...
@Composable
fun ButCh(context: Context = LocalContext.current, navController: NavHostController) {
        ...
        LazyColumn (
            ...
            item {
                Box(
                    ...
                    Text(
                        text = stringResource(id = R.string.butch),
                        style = TextStyle(
                            fontSize = 30.sp,
                            fontWeight = FontWeight.Bold,
                            color = Color.Blue,
            ...
            item {
                Text(
                    text = stringResource(id = R.string.butch_des),
            ...
            item {
                Text(
                    text = stringResource(id = R.string.butch_ing),
                    style = TextStyle(fontSize = 15.sp, color = Color.Black),
                    modifier = Modifier.padding(start = 10.dp, end = 10.dp, bottom = 10.dp)
                )
            }
